...
| promoted | `docs/intake/proyectos/travel-booking-ux-system/03-visual-web-reference/08-auth-viaje-comparar-final.png` | `public/images/projects/travel-booking-ux-system/08-auth-viaje-comparar-final.png` | Used by Travel Booking UX System. |
| promoted | `docs/intake/proyectos/travel-booking-ux-system/03-visual-web-reference/10-auth-booking-plan-final.png` | `public/images/projects/travel-booking-ux-system/10-auth-booking-plan-final.png` | Used by Travel Booking UX System. |
...
- Project source packages under `proyectos/zalmar-travel/` may include internal design references; promote only selected public-safe outputs.
